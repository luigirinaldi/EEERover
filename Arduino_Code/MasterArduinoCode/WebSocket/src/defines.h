...
const char* ssid = "iPhone di Luigi"; //Enter SSID
const char* password = "passwordThatsVeryStrong"; //Enter Password

const char* websockets_server_host = "172.20.10.3"; //Enter server address
...
// IPAddress clientIP(172, 17, 160, 1);
